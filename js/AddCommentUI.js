...
var AddCommentUI = {
  ...
  submit: function AddCommentUI_submit() {
    ...
    self._postOneTBPLNote(alertID, comment, status, bug);
  },
  ...
  openCommentBox: function AddCommentUI_openCommentBox(id, body) {
    ...
    $("#addNotePopup").show();
    alertID = id;
    var focusTextfield = $("#logNoteText");
  ...
  _postOneTBPLNote: function AddCommentUI__postOneTBPLNote(alertID, comment, status, bugid) {
    $.ajax({
